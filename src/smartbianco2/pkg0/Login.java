...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Esquerda, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        jPanel1.add(Direita, gridBagConstraints);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       // 1. Captura o que o usuário digitou nos campos
    String cpfDigitado = txtCPF.getText().trim();
    
    // Para campos de senha (JPasswordField), o correto é usar getPassword() por segurança
    String senhaDigitada = new String(txtSenha.getPassword());
    
    // 2. Define o CPF e a Senha específicos que darão acesso ao sistema
    String cpfCorreto = "123456"; // Substitua pelo CPF desejado (apenas números ou com pontos)
    String senhaCorreta = "1234";      // Substitua pela senha desejada
    
    // 3. Faz a comparação usando o .equals()
    if (cpfDigitado.equals(cpfCorreto) && senhaDigitada.equals(senhaCorreta)) {
        
        PlanoAssinatura AssinaturaFrame = new PlanoAssinatura ();
        AssinaturaFrame.setVisible(true);
        AssinaturaFrame.pack();
        AssinaturaFrame.setLocationRelativeTo(null);
        this.dispose();

        
    } else {
        // SE ERRAR: Mostra uma mensagem de erro na tela
